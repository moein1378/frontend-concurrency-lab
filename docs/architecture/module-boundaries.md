...
- `packages/scenario-engine` owns deterministic fixture generation, scenario transitions, and invariant evaluation. It may depend on the public APIs of `timeline` and `concurrency-core`.
